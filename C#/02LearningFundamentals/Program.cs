    ...
    class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                //ref和out
                int value = 5;
                static void ChangeValue_ref(ref int value){  //通过ref传入引用值
                    value = 3;
                }
                ...
                //变长参数
                static void PrintAll(params string[] items){ //变长参数关键字params
                    foreach (string item in items){          //枚举型for循环
